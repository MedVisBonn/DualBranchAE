...
from models.MultiScaleSegmentation3d import Model  # noqa: E402

def main():
    script_start = time()

    parser = argparse.ArgumentParser(
        description='This script can be used to reproduce the results based on features from a 3D CNN with sparse supervised loss.',
        add_help=False)
    ...
    cfg = {
        ...
        # model settings
        "model_name": "MultiScaleSegmentation3d_set2",
        "latent_dim": 44,
        "width": 33,
        "pad": 14,
    ...
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=cfg["batch_size"], shuffle=True, num_workers=12)
    ...
    testset = Datasets.SlidingVolumesDataset(data_path=data_path,
                                             active_mask_path=brain_mask_path,
                                             tract_masks_path=tract_masks_path,
                                             width=cfg["width"],
                                             pad=cfg["pad"],
        ...
        for epoch in range(1, cfg["num_epochs"] + 1):
            ...
            for batch in trainloader:
                ...
                loss = F.binary_cross_entropy_with_logits(logits, targets,
                                                          ...
                                                          pos_weight=train_cweights[None, :, None, None, None],
                                                          reduction="sum")
    ...
    if cfg["inference"]:
        ...
        print("Test set scores".center(50, "."))
        test_scores = utils.evaluate_conv_classifier(model, testset, device, cfg["labels"], conv_type=3)
